...
<script>
    export default {
        ...
        methods: {
            contentData () {
                this.$http.get('http://192.168.5.15:8080/afterSale/refundBasic/' + this.$route.params.complete_id, {
            ...
            processInformation () { // 订单流程
                this.$http.get('http://192.168.5.15:8080/afterSale/afterRefundProcess/' + this.$route.params.complete_id, {
